(() => {
	const resourceName = typeof GetParentResourceName === 'function' ? GetParentResourceName() : 'vay_zukan_oopart';

	// Percent-based rects measured against the 1376x768 sheet.jpg artwork.
	// Reading order: row1 (col1..5), row2 (col1..5).
	const SLOT_RECTS = [
		{ left: 7.49, top: 35.16, width: 13.30, height: 23.70 },
		{ left: 25.36, top: 35.16, width: 13.30, height: 23.70 },
		{ left: 43.31, top: 35.16, width: 13.37, height: 23.70 },
		{ left: 61.26, top: 35.16, width: 13.30, height: 23.70 },
		{ left: 79.14, top: 35.16, width: 13.30, height: 23.70 },
		{ left: 7.49, top: 65.89, width: 13.30, height: 23.18 },
		{ left: 25.36, top: 65.89, width: 13.30, height: 23.18 },
		{ left: 43.31, top: 65.89, width: 13.37, height: 23.18 },
		{ left: 61.26, top: 65.89, width: 13.30, height: 23.18 },
		{ left: 79.14, top: 65.89, width: 13.30, height: 23.18 },
	];
	const PLAQUE_RECT = { left: 34.88, top: 6.51, width: 29.80, height: 11.07 };
	const FLIP_MS = 320;
