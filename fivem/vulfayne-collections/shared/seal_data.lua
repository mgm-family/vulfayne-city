...
-- civil/civilian/criminal factions. `Coords` is left unset here on
-- purpose -- see data_helpers.lua and README.md for how to place real
-- ones with /vulfayne_getcoord. Drop matching images at
-- html/images/<ItemId>.png (e.g. Seal_S1_I1.png) for the album UI.
...
local data = {
	...
	-- ^ uncomment and fill in once you've picked a spot for the seal-collector NPC.
}
