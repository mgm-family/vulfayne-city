(() => {
	const resourceName = typeof GetParentResourceName === 'function' ? GetParentResourceName() : 'vay_zukan_seal';

	// Percent-based rects measured against the 1376x768 sheet.jpg artwork.
	// Reading order: row1 (col1..5), row2 (col1..5).
	const SLOT_RECTS = [
		{ left: 13.08, top: 38.54, width: 11.77, height: 20.70 },
		{ left: 28.63, top: 38.54, width: 11.77, height: 20.70 },
		{ left: 44.11, top: 38.54, width: 11.77, height: 20.70 },
		{ left: 59.67, top: 38.54, width: 11.70, height: 20.70 },
		{ left: 75.15, top: 38.54, width: 11.77, height: 20.70 },
		{ left: 13.08, top: 64.71, width: 11.77, height: 20.96 },
		{ left: 28.63, top: 64.71, width: 11.77, height: 20.96 },
		{ left: 44.11, top: 64.71, width: 11.77, height: 20.96 },
		{ left: 59.67, top: 64.71, width: 11.70, height: 20.96 },
		{ left: 75.15, top: 64.71, width: 11.77, height: 20.96 },
	];
	const PLAQUE_RECT = { left: 34.88, top: 8.46, width: 29.07, height: 13.67 };
	const FLIP_MS = 320;
